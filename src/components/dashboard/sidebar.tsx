    ...
    <aside className="fixed left-0 top-0 h-screen w-64 bg-bg-secondary border-r border-border flex flex-col z-50">
      ...
      <div className="p-6 border-b border-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm font-bold text-text-primary">Team Hub</h1>
            <p className="text-xs text-text-muted">Altcointurk</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-border">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-9 h-9 rounded-full bg-brand-primary/20 flex items-center justify-center text-brand-primary font-semibold text-sm">
            {user.name.charAt(0).toUpperCase()}
          </div>
          <div className="min-w-0">
            <p className="text-sm font-medium text-text-primary truncate">{user.name}</p>
            <p className="text-xs text-text-muted truncate">
              {user.xHandle ? `@${user.xHandle}` : "X bağlı değil"}
            </p>
          </div>
        </div>
